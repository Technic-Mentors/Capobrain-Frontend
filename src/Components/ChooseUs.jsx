                ...
                <div className={`row g-${screen} chooseSection text-center`}>
                    <div className="col-md-4">
                        <div className="card">
                            <div className="card-body">
                                ...
                                <p className='mt-3 seo-heading-h3'>Proven Track Record</p>
                    ...
                    <div className="col-md-4">
                        <div className="card">
                            <div className="card-body">
                                <i className='fas fa-arrow-right'></i>
                                <p className='mt-3 seo-heading-h3'>User Satisfaction</p>
                    ...
                    <div className="col-md-4">
                        <div className="card">
                            <div className="card-body">
                                <i className='fas fa-arrow-right'></i>
                                <p className='mt-3 seo-heading-h3'>Efficiency Boost</p>
                    ...
                    <div className="col-md-4">
                        <div className="card mt-lg-3">
                            <div className="card-body">
                                <i className='fas fa-arrow-right'></i>
                                <p className='mt-3 seo-heading-h3'>Cost Savings</p>
