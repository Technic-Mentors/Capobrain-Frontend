                  ...
                  <div className="">
                    <div>
                      <h1 className="animate__animated animate__zoomIn">
                        Comprehensive School Software Features
                      </h1>
                    </div>
                  </div>
                </div>
        ...
        <div className="container">
          ...
          >
            <h2>
              ...
              Standout Features Of Comprehensive School Software
            </h2>
          </div>
              ...
              <div className="services-item3 bg-light">
                <div className="p-2 text-center services-content">
                  <div className="services-content-icon3">
                    ...
                    <p style={{fontSize: '18px', fontWeight: 'bold'}} className="mb-3 seo-heading-h3">Cloud-Based System</p>
                    <p className="mb-4">
              ...
              <div className="services-item3 bg-light">
                <div className="p-2 text-center services-content">
                  <div className="services-content-icon3">
                    ...
                    <p style={{fontSize: '18px', fontWeight: 'bold'}} className="mb-3 seo-heading-h3">Latest Cutting-Edge Technologies</p>
                    <p className="mb-4">
              ...
              <div className="services-item3 bg-light">
                <div className="p-2 text-center services-content">
                  <div className="services-content-icon3">
                    ...
                    <p style={{fontSize: '18px', fontWeight: 'bold'}} className="mb-3 seo-heading-h3">Computer-Based Exam Solutions</p>
                    <p className="mb-4">
              ...
              <div className="services-item3 bg-light">
                <div className="p-2 text-center services-content">
                  <div className="services-content-icon3">
                    ...
                    <p style={{fontSize: '18px', fontWeight: 'bold'}} className="mb-3 seo-heading-h3">Artificial Intelligence Based</p>
                    <p className="mb-4">
              ...
              <div className="services-item3 bg-light">
                <div className="p-2 text-center services-content">
                  <div className="services-content-icon3">
                    ...
                    <p style={{fontSize: '18px', fontWeight: 'bold'}} className="mb-3 seo-heading-h3">Data Security</p>
                    <p className="mb-4">
              ...
              <div className="services-item3 bg-light">
                <div className="p-2 text-center services-content">
                  <div className="services-content-icon3">
                    ...
                    <p style={{fontSize: '18px', fontWeight: 'bold'}} className="mb-3 seo-heading-h3">Students & Parent Portals</p>
                    <p className="mb-4">
              ...
              <div className="services-item3 bg-light">
                <div className="p-2 text-center services-content">
                  <div className="services-content-icon3">
                    ...
                    <p style={{fontSize: '18px', fontWeight: 'bold'}} className="mb-3 seo-heading-h3">Online Daily Diary</p>
                    <p className="mb-4">
              ...
              <div className="services-item3 bg-light">
                <div className="p-2 text-center services-content">
                  <div className="services-content-icon3">
                    ...
                    <p style={{fontSize: '18px', fontWeight: 'bold'}} className="mb-3 seo-heading-h3">Mobile App Support</p>
                    <p className="mb-4">
              ...
              <div className="services-item3 bg-light">
                <div className="p-2 text-center services-content">
                  <div className="services-content-icon3">
                    ...
                    <p style={{fontSize: '18px', fontWeight: 'bold'}} className="mb-3 seo-heading-h3">WhatsApp Messaging</p>
                    <p className="mb-4">
              ...
              <div className="services-item3 bg-light">
                <div className="p-2 text-center services-content">
                  <div className="services-content-icon3">
                    ...
                    <p style={{fontSize: '18px', fontWeight: 'bold'}} className="mb-3 seo-heading-h3">Biometric Attendance</p>
                    <p className="mb-4">
              ...
              <div className="services-item3 bg-light">
                <div className="p-2 text-center services-content">
                  <div className="services-content-icon3">
                    ...
                    <p style={{fontSize: '18px', fontWeight: 'bold'}} className="mb-3 seo-heading-h3">Salary & Fee Management</p>
                    <p className="mb-4">
              ...
              <div className="services-item3 bg-light">
                <div className="p-2 text-center services-content">
                  <div className="services-content-icon3">
                    ...
                    <p style={{fontSize: '18px', fontWeight: 'bold'}} className="mb-3 seo-heading-h3">Inventory Management</p>
                    <p className="mb-4">
              ...
              <div className="services-item3 bg-light">
                <div className="p-2 text-center services-content">
                  <div className="services-content-icon3">
                    ...
                    <p style={{fontSize: '18px', fontWeight: 'bold'}} className="mb-3 seo-heading-h3">Student & Staff Ledgers</p>
                    <p className="mb-4">
              ...
              <div className="services-item3 bg-light">
                <div className="p-2 text-center services-content">
                  <div className="services-content-icon3">
                    ...
                    <p style={{fontSize: '18px', fontWeight: 'bold'}} className="mb-3 seo-heading-h3">Reminders For Fee Collection</p>
                    <p className="mb-4">
              ...
              <div className="services-item3 bg-light">
                <div className="p-2 text-center services-content">
                  <div className="services-content-icon3">
                    ...
                    <p style={{fontSize: '18px', fontWeight: 'bold'}} className="mb-3 seo-heading-h3">Expense & Assets Management</p>
                    <p className="mb-4">
              ...
              <div className="services-item3 bg-light">
                <div className="p-2 text-center services-content">
                  <div className="services-content-icon3">
                    ...
                    <p style={{fontSize: '18px', fontWeight: 'bold'}} className="mb-3 seo-heading-h3">Online Paper Generation</p>
                    <p className="mb-4">
              ...
              <div className="services-item3 bg-light">
                <div className="p-2 text-center services-content">
                  <div className="services-content-icon3">
                    ...
                    <p style={{fontSize: '18px', fontWeight: 'bold'}} className="mb-3 seo-heading-h3">Exams & Results Management</p>
                    <p className="mb-4">
              ...
              <div className="services-item3 bg-light">
                <div className="p-2 text-center services-content">
                  <div className="services-content-icon3">
                    ...
                    <p style={{fontSize: '18px', fontWeight: 'bold'}} className="mb-3 seo-heading-h3">Comprehensive Reporting</p>
                    <p className="mb-4">
              ...
              <div className="services-item3 bg-light">
                <div className="p-2 text-center services-content">
                  <div className="services-content-icon3">
                    ...
                    <p style={{fontSize: '18px', fontWeight: 'bold'}} className="mb-3 seo-heading-h3">Multi Branches/ Campuses</p>
                    <p className="mb-4">
              ...
              <div className="services-item3 bg-light">
                <div className="p-2 text-center services-content">
                  <div className="services-content-icon3">
                    ...
                    <p style={{fontSize: '18px', fontWeight: 'bold'}} className="mb-3 seo-heading-h3">School/ College Front Website</p>
                    <p className="mb-4">
            ...
            <div className="container">
              <div className="row d-flex align-items-center justify-content-between pt-5 pb-5 mt-3">
                <div className="col-md-8">
                  <h2 style={{ color: "initial", fontSize: "35px", fontWeight: "bold" }}>Learn more about our advanced Education Management Software!
                  </h2>
                </div>
