...
export default function Pricing() {
  ...
  return (
    <div className="mt-5 mb-4">
      ...
      Get Know The <span style={{ color: "#00B6C7" }}>Basics & Simple</span> Pricing Plans
      ...
      <div className="container">
        <div className="row">
          <div className="col-md-6">
            <h3>Elevate Your <span style={{ color: "#00B6C7" }}>Institution</span> with <span style={{ color: "#00B6C7" }}>Capobrain</span></h3>
          ...
          <div className="col-md-6">
            <h3>Greening <span style={{ color: "#00B6C7" }}>Education</span> with <span style={{ color: "#00B6C7" }}>Capobrain</span></h3>
