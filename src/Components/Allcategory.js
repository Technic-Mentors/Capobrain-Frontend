...
export default function Allcategory() {
  ...
  const viewCategory = async (id) => {
    await fetch(`https://capobrain-backend.vercel.app/api/auth/getcategory/${id}`, {
      method: "GET",
    })
      .then((res) => res.json())
  ...
  const deleteCategory = async (id) => {
    ...
    if (isConfirmed) {
      await fetch(`https://capobrain-backend.vercel.app/api/auth/delcategory/${id}`, {
        method: "DELETE",
      });
    }
    Getcategory();
  ...
  const updateCategory = async () => {
    await fetch(`https://capobrain-backend.vercel.app/api/auth/editcategory/${editId}`, {
      method: "PUT",
      headers: {
